            ...
            <form className='mt-8 flex flex-col gap-4'>
              ...
              <div className='grid grid-cols-2 gap-6'>
                ...
                <div className='flex flex-col gap-2'>
                  ...
                  <Input id="name" type="text" placeholder="Usuário #0000" />
                </div>
              </div>
              ...
              <footer className='mt-4 flex justify-end gap-4'>
                ...
                <button
                  type='submit'
                  className='bg-violet-500 px-5 py-3 rounded-md font-semibold flex items-center gap-3 hover:bg-violet-600'
                >
